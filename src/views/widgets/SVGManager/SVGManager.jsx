...
export const CubegoFooter = ({ stroke, fill }) => (
  <svg width="100%" height="100%" viewBox="0 0 692 261" preserveAspectRatio="none" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
    <defs>
      <path d="M0,19.1507638 C115.493567,6.38358794 230.8269,4.27055815e-15 346,0 C461.1731,0 576.506433,6.38358794 692,19.1507638 L692,205.150764 C576.666667,205.150764 461.333333,205.150764 346,205.150764 C230.666667,205.150764 115.333333,205.150764 0,205.150764 L0,19.1507638 Z" id="cubego-path-filter" />
      <filter x="-2.3%" y="-7.8%" width="104.6%" height="115.6%" filterUnits="objectBoundingBox" id="cubego-filter">
        ...
        <feColorMatrix values="0 0 0 0 0.857408588   0 0 0 0 0.857408588   0 0 0 0 0.857408588  0 0 0 0.5 0" type="matrix" in="shadowInnerInner1" />
      </filter>
    </defs>
    <g id="cubego-footer" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g id="Rectangle-2">
        <use fill={fill} fillRule="evenodd" href="#cubego-path-filter" />
        <use fill="blue" fillOpacity="1" filter="url(#cubego-filter)" href="#cubego-path-filter" />
      ...
      <polygon id="Path-2" fill="#043E63" points="12.0456242 205 4.814599 260.354955 682.568042 205" />
    </g>
  </svg>
);
...
export const CustomRectangleWithShadow = () => (
  <svg width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 692 206" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
    <defs>
      <path d="M0,19.1507638 C115.493567,6.38358794 230.8269,4.27055815e-15 346,0 C461.1731,0 576.506433,6.38358794 692,19.1507638 L692,205.150764 C576.666667,205.150764 461.333333,205.150764 346,205.150764 C230.666667,205.150764 115.333333,205.150764 0,205.150764 L0,19.1507638 Z" id="rectangle-with-shadow" />
      <filter x="-2.9%" y="-9.7%" width="105.8%" height="119.5%" filterUnits="objectBoundingBox" id="rectangle-with-shadow-filter">
        ...
        <feOffset dx="0" dy="0" in="shadowBlurInner1" result="shadowOffsetInner1" />
        <feComposite in="shadowOffsetInner1" in2="SourceAlpha" operator="arithmetic" k2="-1" k3="1" result="shadowInnerInner1" />
        <feColorMatrix values="0 0 0 0 0.117647059   0 0 0 0 0.37254902   0 0 0 0 0.611764706  0 0 0 1 0" type="matrix" in="shadowInnerInner1" />
      </filter>
    </defs>
    <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g id="Rectangle-2">
        <use fill="#12314F" fillRule="evenodd" href="#rectangle-with-shadow" />
        <use fill="black" fillOpacity="1" filter="url(#rectangle-with-shadow-filter)" href="#rectangle-with-shadow" />
  ...
  <svg width="100%" height="100%" viewBox="0 0 692 206" preserveAspectRatio="none" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
    <defs>
      <linearGradient x1="99.0617944%" y1="99.3010462%" x2="0%" y2="10.3323555%" id="customrectangle-gradient-pack">
        <stop stopColor="#C30D46" offset="0%" />
        <stop stopColor="#FFFF00" offset="50%" />
        <stop stopColor="#C30D46" offset="100%" />
      </linearGradient>
      <linearGradient x1="99.0617944%" y1="99.3010462%" x2="0%" y2="10.3323555%" id="customrectangle-gradient-epic">
        <stop stopColor="#FF4F02" offset="0%" />
        <stop stopColor="#FFFF00" offset="50%" />
        <stop stopColor="#FF6D00" offset="100%" />
      </linearGradient>
      <linearGradient x1="99.0617944%" y1="99.3010462%" x2="0%" y2="10.3323555%" id="customrectangle-gradient-rare">
        <stop stopColor="#9DF2F1" offset="0%" />
        <stop stopColor="#9DF2F1" offset="50%" />
        <stop stopColor="#9DF2F1" offset="100%" />
      </linearGradient>
      <linearGradient x1="99.0617944%" y1="99.3010462%" x2="0%" y2="10.3323555%" id="customrectangle-gradient-referral">
        <stop stopColor="#75C3F5" offset="0%" />
        <stop stopColor="#75C3F5" offset="50%" />
        <stop stopColor="#75C3F5" offset="100%" />
      </linearGradient>
    </defs>
    <g id="CustomRectangle" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <path d="M5,23.6432469 L5,200.162356 L687,200.162356 L687,23.6432469 C573.176134,11.222086 459.509728,5.01159184 346,5.01159184 C232.490272,5.01159184 118.823866,11.222086 5,23.6432469 Z" id="Rectangle-2" stroke={`url(#customrectangle-gradient-${tier})`} fill={fill} strokeWidth={strokeWidth} />
    </g>
  </svg>
);
  ...
  <svg width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 3716 2243" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
    <defs>
      <linearGradient x1="0%" y1="0%" x2="100%" y2="100%" id="discount-1">
        <stop stopColor="#50457D" offset="0%" />
        <stop stopColor="#B1C250" offset="41.9594473%" />
        <stop stopColor="#891D48" offset="100%" />
      </linearGradient>
      <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="discount-2">
        <stop stopColor="#542F44" offset="0%" />
        <stop stopColor="#CE000C" offset="52.4092305%" />
        <stop stopColor="#6C0A18" offset="100%" />
      </linearGradient>
    </defs>
    <g id="discount-frame" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <polygon id="Path-3" fill="#50030E" points="2722.51663 0 2675 142.226793 2815 92.523309" />
      <polygon id="Path-3" fill="#50030E" transform="translate(3638.931388, 980.442734) rotate(118.000000) translate(-3638.931388, -980.442734) " points="3615.27297 900.765461 3565.27297 1060.12001 3712.5898 1004.43095" />
      <rect id="Rectangle-8" stroke="url(#discount-1)" strokeWidth="30" x="25" y="113" width="3552" height="2105" />
      <polygon id="Rectangle-9" fill="url(#discount-2)" transform="translate(3340.002800, 382.002800) rotate(-45.000000) translate(-3340.002800, -382.002800) " points="3173.39029 1090.79245 3173.39029 -326.786846 3506.61531 18.0825465 3506.61531 749.258096" />
...
const getHeightFromValue = (val) => {
  const v = Math.min(Math.sqrt(val), 10);
  return -110 + 10 * v;
};

export const MaterialStatistics = ({
  _t, num_cubes, m1, m2, m3, m4,
}) => {
    ...
    <svg className="material-stats" width="100%" height="100%" viewBox="0 0 1054 1291" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
      ...
      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="left" transform={`translate(0.000000, ${-_m1.height + 365.000000})`}>
          <polygon id="Rectangle-10" fill={MaterialStatistics.materialMap[_m1.id].fillRight} points="202.080736 80 404.161472 241.080736 202.080736 402.16 0 241.080736" />
          <polygon id="Path-6" fill={MaterialStatistics.materialMap[_m1.id].fillLeft} points={`0.763327361 241.158054 0.763327361 ${368.997641 + _m1.height} 202.405472 ${529.857031 + _m1.height} 202.405472 400.880243`} />
          <polygon id="Path-6" fill={MaterialStatistics.materialMap[_m1.id].fillTop} points={`202 ${529.698977 + _m1.height} 202 401.85939 403.642145 241 403.642145 ${369.976788 + _m1.height}`} />
          {_m1.id !== -1
            ? (
        ...
        <g id="right" transform={`translate(649.000000, ${-_m2.height + 365.000000})`}>
          <polygon id="Rectangle-10" fill={MaterialStatistics.materialMap[_m2.id].fillRight} points="202.080736 96 404.161472 257.080736 202.080736 418.16 0 257.080736" />
          <polygon id="Path-6" fill={MaterialStatistics.materialMap[_m2.id].fillLeft} points={`0.763327361 257.158054 0.763327361 ${384.997641 + _m2.height} 202.405472 ${545.857031 + _m2.height} 202.405472 416.880243`} />
          <polygon id="Path-6" fill={MaterialStatistics.materialMap[_m2.id].fillTop} points={`202 ${545.698977 + _m2.height} 202 417.85939 403.642145 257 403.642145 ${385.976788 + _m2.height}`} />
          {_m2.id !== -1
            ? (
        ...
        <g id="bottom" transform={`translate(315.000000, ${-_m3.height + 740})`}>
          <polygon id="Rectangle-10" fill={MaterialStatistics.materialMap[_m3.id].fillRight} points="202.080736 1.8189894e-12 404.161472 161.080736 202.080736 322.16 0 161.080736" />
          <polygon id="Path-6" fill={MaterialStatistics.materialMap[_m3.id].fillLeft} points={`0.763327361 161.158054 0.763327361 ${288.997641 + _m3.height} 202.405472 ${449.857031 + _m3.height} 202.405472 320.880243`} />
          <polygon id="Path-6" fill={MaterialStatistics.materialMap[_m3.id].fillTop} points={`202 ${449.698977 + _m3.height} 202 321.85939 403.642145 161 403.642145 ${289.976788 + _m3.height}`} />
          {_m3.id !== -1
            ? (
        ...
        <g id="top" transform={`translate(315.000000, ${-_m4.height + 60})`}>
          <polygon id="Rectangle-10" fill={MaterialStatistics.materialMap[_m4.id].fillRight} points="202.080736 90 404.161472 251.080736 202.080736 412.16 0 251.080736" />
          <polygon id="Path-6" fill={MaterialStatistics.materialMap[_m4.id].fillLeft} points={`0.763327361 251.158054 0.763327361 ${378.997641 + _m4.height} 202.405472 ${539.857031 + _m4.height} 202.405472 410.880243`} />
          <polygon id="Path-6" fill={MaterialStatistics.materialMap[_m4.id].fillTop} points={`202 ${539.698977 + _m4.height} 202 411.85939 403.642145 251 403.642145 ${379.976788 + _m4.height}`} />
