...
import { CubegoFooter } from '../../widgets/SVGManager/SVGManager.jsx';
...
export const CubegoCard = ({_t, img, name, point, tier, available_amount, className, onTransferFunc}) => {
  return(
      ...
      <div className="border-1">
        <div className="border-2">
          ...
          <div className={'img-wrapper'}>
            ...
            {onTransferFunc ?
              <div className={"transfer-cube"} onClick={onTransferFunc}>
                {_t('transfer')}
              </div> : null
            }
          </div>
