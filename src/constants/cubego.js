...
const _CUBE_MATERIALS = {
  [CUBE_MATERIALS_MAP.diamond]: {
    ...
    name: 'diamond',
    sub_materials: {
      [CUBE_MATERIALS_MAP.diamond * 100 + 1]: {color: '#93A2B3', emissive: '#1B0F55',},
      [CUBE_MATERIALS_MAP.diamond * 100 + 2]: {color: '#ff0000', emissive: '#0c0043',},
      [CUBE_MATERIALS_MAP.diamond * 100 + 3]: {color: '#00b35f', emissive: '#021409',},
      [CUBE_MATERIALS_MAP.diamond * 100 + 4]: {color: '#c88d00', emissive: '#390000',},
      [CUBE_MATERIALS_MAP.diamond * 100 + 5]: {color: '#c80046', emissive: '#0d0039',}
    },
    point: 3000,
  ...
  [CUBE_MATERIALS_MAP.ice]: {
    ...
    name: 'ice',
    sub_materials: {
      [CUBE_MATERIALS_MAP.ice * 100 + 1]: {color: '#5d6569', emissive: '#222222'},
      [CUBE_MATERIALS_MAP.ice * 100 + 2]: {color: '#8c2e44', emissive: '#250505'},
      [CUBE_MATERIALS_MAP.ice * 100 + 3]: {color: '#4b7046', emissive: '#13191e'},
      [CUBE_MATERIALS_MAP.ice * 100 + 4]: {color: '#823228', emissive: '#25051c'},
      [CUBE_MATERIALS_MAP.ice * 100 + 5]: {color: '#725e1a', emissive: '#250505'}
    },
    point: 300,
    tier: CUBE_TIER_MAP.epic,
  },
  [CUBE_MATERIALS_MAP.silver]: {
    ...
    name: 'silver',
    sub_materials: {
      [CUBE_MATERIALS_MAP.silver * 100 + 1]: {color: '#afafaf', emissive: '#181818'},
      [CUBE_MATERIALS_MAP.silver * 100 + 2]: {color: '#907898', emissive: '#100425'},
      [CUBE_MATERIALS_MAP.silver * 100 + 3]: {color: '#4eaafc', emissive: '#100425'},
      [CUBE_MATERIALS_MAP.silver * 100 + 4]: {color: '#dc3b3b', emissive: '#901090'},
  ...
  [CUBE_MATERIALS_MAP.stone]: {
    ...
    name: 'stone',
    sub_materials: {
      [CUBE_MATERIALS_MAP.stone * 100 + 1]: {color: '#4a4a48', emissive: '#1e130c'},
      [CUBE_MATERIALS_MAP.stone * 100 + 2]: {color: '#5f2929', emissive: '#1e0c01'},
      [CUBE_MATERIALS_MAP.stone * 100 + 3]: {color: '#5f295b', emissive: '#1b0c02'},
      [CUBE_MATERIALS_MAP.stone * 100 + 4]: {color: '#0f2a3e', emissive: '#1b0c02'},
      [CUBE_MATERIALS_MAP.stone * 100 + 5]: {color: '#18433b', emissive: '#1b0c02'},
      [CUBE_MATERIALS_MAP.stone * 100 + 6]: {color: '#52451b', emissive: '#1b0c02'},
      [CUBE_MATERIALS_MAP.stone * 100 + 7]: {color: '#552d1c', emissive: '#160303'},
      [CUBE_MATERIALS_MAP.stone * 100 + 8]: {color: '#39261e', emissive: '#220501'}
    },
    point: 50,
    tier: CUBE_TIER_MAP.rare,
  },
  [CUBE_MATERIALS_MAP.wood]: {
    ...
    name: 'wood',
    sub_materials: {
      [CUBE_MATERIALS_MAP.wood * 100 + 1]: {color: '#89561b', emissive: '#3e0000'},
      [CUBE_MATERIALS_MAP.wood * 100 + 2]: {color: '#6b3030', emissive: '#340000'},
  ...
  [CUBE_MATERIALS_MAP.leaf]: {
    ...
    sub_materials: {
      ...
      [CUBE_MATERIALS_MAP.leaf * 100 + 6]: {color: '#781a6d', emissive: '#0e0a1b'},
    },
    price: 0.0005,
    is_for_sale: true,
    point: 5,
  ...
  [CUBE_MATERIALS_MAP.fur]: {
    ...
    name: 'fur',
    sub_materials: {
      [CUBE_MATERIALS_MAP.fur * 100 + 1]: {color: '#78593b', emissive: '#221822'},
      ...
      [CUBE_MATERIALS_MAP.fur * 100 + 9]: {color: '#7e7e7f', emissive: '#090909'},
  ...
  [CUBE_MATERIALS_MAP.paper]: {
    ...
    sub_materials: {
      ...
      [CUBE_MATERIALS_MAP.paper * 100 + 2]: {color: '#7f0043', emissive: '#91253f'},
      ...
      [CUBE_MATERIALS_MAP.paper * 100 + 7]: {color: '#756808', emissive: '#8e6212'},
      [CUBE_MATERIALS_MAP.paper * 100 + 8]: {color: '#ac681c', emissive: '#8e3012'},
      [CUBE_MATERIALS_MAP.paper * 100 + 9]: {color: '#757575', emissive: '#64544f'},
  ...
  [CUBE_MATERIALS_MAP.plastic]: {
    ...
    sub_materials: {
      ...
      [CUBE_MATERIALS_MAP.plastic * 100 + 2]: {color: '#6500d7', emissive: '#7d2424'},
      [CUBE_MATERIALS_MAP.plastic * 100 + 3]: {color: '#0032d7', emissive: '#7d2424'},
      [CUBE_MATERIALS_MAP.plastic * 100 + 4]: {color: '#0071d7', emissive: '#7d2424'},
      [CUBE_MATERIALS_MAP.plastic * 100 + 5]: {color: '#006919', emissive: '#7d2424'},
      [CUBE_MATERIALS_MAP.plastic * 100 + 6]: {color: '#695000', emissive: '#7d2424'},
    },
    point: 1,
