...
export const SUB_MATERIAL_TYPE_POINTS = {
  [CUBE_MATERIALS_NAME_TO_ID.diamond*100+1]: [0, 0, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.diamond*100+2]: [0, 0, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.diamond*100+3]: [0, 1, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.diamond*100+4]: [0, 0, 0, 0, 1],
  [CUBE_MATERIALS_NAME_TO_ID.diamond*100+5]: [1, 0, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.gold*100+1]: [0, 0, 0, 1, 1],
  [CUBE_MATERIALS_NAME_TO_ID.ice*100+1]: [1, 0, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.ice*100+2]: [0, 1, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.ice*100+3]: [0, 1, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.ice*100+4]: [1, 0, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.ice*100+5]: [1, 0, 0, 0, 1],
  [CUBE_MATERIALS_NAME_TO_ID.silver*100+1]: [1, 0, 0, 0, 1],
  [CUBE_MATERIALS_NAME_TO_ID.silver*100+2]: [0, 0, 1, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.silver*100+3]: [0, 1, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.silver*100+4]: [1, 0, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.silver*100+5]: [0, 1, 0, 0, 1],
  [CUBE_MATERIALS_NAME_TO_ID.iron*100+1]: [0, 0, 0, 1, 1],
  [CUBE_MATERIALS_NAME_TO_ID.iron*100+2]: [1, 0, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.iron*100+3]: [0, 0, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.iron*100+4]: [0, 1, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.iron*100+5]: [0, 0, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.iron*100+6]: [0, 1, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.iron*100+7]: [1, 0, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.iron*100+8]: [0, 0, 0, 0, 1],
  [CUBE_MATERIALS_NAME_TO_ID.stone*100+1]: [1, 0, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.stone*100+2]: [0, 0, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.stone*100+3]: [0, 1, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.stone*100+4]: [0, 0, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.stone*100+5]: [0, 1, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.stone*100+6]: [1, 0, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.stone*100+7]: [0, 1, 0, 0, 1],
  [CUBE_MATERIALS_NAME_TO_ID.stone*100+8]: [0, 0, 0, 0, 1],
  [CUBE_MATERIALS_NAME_TO_ID.wood*100+1]: [0, 0, 0, 0, 1],
  [CUBE_MATERIALS_NAME_TO_ID.wood*100+2]: [0, 0, 0, 1, 1],
  [CUBE_MATERIALS_NAME_TO_ID.wood*100+3]: [0, 1, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.wood*100+4]: [0, 0, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.wood*100+5]: [1, 0, 1, 0, 1],
  [CUBE_MATERIALS_NAME_TO_ID.wood*100+6]: [0, 1, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.wood*100+7]: [0, 0, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.wood*100+8]: [1, 0, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.brick*100+1]: [0, 0, 0, 0, 1],
  [CUBE_MATERIALS_NAME_TO_ID.brick*100+2]: [0, 0, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.brick*100+3]: [1, 0, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.brick*100+4]: [0, 0, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.brick*100+5]: [0, 0, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.brick*100+6]: [0, 1, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.brick*100+7]: [0, 0, 0, 0, 1],
  [CUBE_MATERIALS_NAME_TO_ID.brick*100+8]: [1, 0, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.brick*100+9]: [0, 0, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.leaf*100+1]: [0, 1, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.leaf*100+2]: [0, 0, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.leaf*100+3]: [0, 0, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.leaf*100+4]: [0, 0, 0, 0, 1],
  [CUBE_MATERIALS_NAME_TO_ID.leaf*100+5]: [1, 0, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.leaf*100+6]: [0, 1, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.fur*100+1]: [0, 0, 0, 0, 1],
  [CUBE_MATERIALS_NAME_TO_ID.fur*100+2]: [0, 0, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.fur*100+3]: [1, 0, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.fur*100+4]: [0, 0, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.fur*100+5]: [0, 1, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.fur*100+6]: [0, 0, 0, 0, 1],
  [CUBE_MATERIALS_NAME_TO_ID.fur*100+7]: [0, 0, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.fur*100+8]: [0, 1, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.fur*100+9]: [1, 0, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.fur*100+10]: [0, 0, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.paper*100+1]: [0, 0, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.paper*100+2]: [0, 0, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.paper*100+3]: [0, 0, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.paper*100+4]: [1, 0, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.paper*100+5]: [0, 0, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.paper*100+6]: [0, 1, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.paper*100+7]: [0, 0, 0, 0, 1],
  [CUBE_MATERIALS_NAME_TO_ID.paper*100+8]: [0, 0, 0, 0, 1],
  [CUBE_MATERIALS_NAME_TO_ID.paper*100+9]: [1, 0, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.paper*100+10]: [0, 1, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.plastic*100+1]: [0, 0, 0, 1, 0],
  [CUBE_MATERIALS_NAME_TO_ID.plastic*100+2]: [1, 1, 1, 1, 1],
  [CUBE_MATERIALS_NAME_TO_ID.plastic*100+3]: [0, 0, 1, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.plastic*100+4]: [1, 0, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.plastic*100+5]: [0, 1, 0, 0, 0],
  [CUBE_MATERIALS_NAME_TO_ID.plastic*100+6]: [0, 0, 0, 0, 1],
};
